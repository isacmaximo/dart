//Projeto Cálculo IMC - Versão final
...
class _HomeState extends State<Home> {
  ...
  //para validar as entradas, ou seja, para que os campos não fiquem em branco,
  //vamos criar uma global key que vai validar o input(formulário);
  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  //texto de baixo que irá exibir as informações
  ...
  void _resetFields() {
    ...
    //não precisamos colocar o peso e a altura no setstate,
    //pois os controladores já fazem isso
    weightController.text = "";
    heightController.text = "";
    setState(() {
      _infoTeste = "Informe seus dados";
      //aqui serve para resetar a validação, ou seja, não ficar campos de erro,
      //após clicar  no botão reset
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          //aqui foi trocado o filho do scroll para um Form, isto é,
          //podemos fazer configurações de input(formulário),
          //coluna fica dentro de form.
          child: Form(
            //chave que vai servir para validação do usuário
            key: _formKey,
            child: Column(
              ...
              children: <Widget>[
                ...
                //aqui colocaremos um campo onde o usuário pode digitar (input):
                //queremos que esse input receba entradas do tipo número:

                //input  do peso:
                //se colocarmos apenas textfield não podemos configurar,
                //a validação do form, para isso usamos TextFormField
                TextFormField(
                  ...
                  //aqui colocaremos um validador que vai receber,
                  //uma função anônima que vai receber um valor,
                  // e vai fazer a verificação
                  validator: (value) {
                    if (value!.isEmpty) {
                ...
                Padding(
                  ...
                  child: //*antes usava-se RaisedButton
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        //se for verificado que é válido, então a função,
                        //calcular é chamada
                        //esta verificação ocorre ao pressionar o botão
